            <?php
            function bank_attack(array & $state, array & $events): void
        {
            global $gangs;
            ...
            $g = null;
            foreach ($gangs as $gg) {
                if ($gg['Name'] === $state['currentGang']) { $g = $gg; break; }
            }
            ...
            while ($security > 0 && $state['playerHealth'] > 0) {
                ...
                if ($state['playerHealth'] < 20 && $state["playerHealth"]>0&&rand_range(1,100) <= 99) {
